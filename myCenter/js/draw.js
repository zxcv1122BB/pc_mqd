...
var pc = new Vue({
	...
	data: {
		...
		userInfoList:'',
			...
			wqf_num:'',
        bankList: ['土地銀行', '臺灣銀行', '合庫商銀', '第一銀行', '華南銀行', '彰化銀行', '台北富邦', '上海銀行', '花旗(台灣)銀行', '農業金庫', '兆豐商銀', '高雄銀行', '國泰世華', '首都銀行', '澳商澳盛銀行(荷蘭銀行)', '中華開發', '臺灣企銀','渣打國際商銀(新竹銀行)', '台中商銀','京城商銀', '東亞銀行','德意志銀行', '永豐銀行','大台北銀行','華泰銀行','臺灣新光商銀','陽信銀行','聯邦銀行','板信銀行','三信銀行','遠東銀行','元大銀行','永豐銀行','玉山銀行','凱基銀行(萬泰銀行)','星展銀行(寶華商業銀行)','大眾銀行','台新銀行','日盛銀行','中國信託','安泰銀行','中華郵政']
	},
	created: function() {
