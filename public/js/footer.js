...
document.writeln('<div class="footer"><div class="w-1200"><div class="bottom-nav fl"><div class="footer-nav"><a href="/help.html?0" class="">{{i18n.t("关于我们")}}</a><a href="/help.html?1" class="">{{i18n.t("联繫我们")}}</a><a href="/help.html?2" class="">{{i18n.t("常见问题")}}</a><a href="/help.html?3" class="">{{i18n.t("取款帮助")}}</a><a href="/help.html?4" class="">{{i18n.t("存款帮助")}}</a><a href="/help.html?5" class="">{{i18n.t("隐私保护规则")}}</a><a href="/help.html?6" class="">{{i18n.t("规则与条款")}}</a></div> <p>© 2011-2020 <strong class="platform">{{i18n.t("玛奇朵")}} {{i18n.t("彩票")}}</strong>{{i18n.t("版权所有")}}</p> <p><strong class="platform">{{i18n.t("玛奇朵")}} {{i18n.t("彩票")}}</strong>{{i18n.t("郑重提示")}}：{{i18n.t("彩票有风险")}}，{{i18n.t("投注需谨慎")}}，{{i18n.t("不向未满")}} 18 {{i18n.t("周岁的青少年出售彩票")}}</p></div> <div class="authorized fr"><div id="qrcode2"><img src="../../images/IMG_9849.png" style="width:120px;height:120px;" /></div><p>{{i18n.t("扫码下载手机版")}}</p> </div></div></div>');
